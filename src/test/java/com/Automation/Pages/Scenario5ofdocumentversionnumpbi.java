...
public class Scenario5ofdocumentversionnumpbi extends ActionEngine {
	Properties prop;
...
//	@FindBy(xpath = "//span[text()='Print']")
  ...
  /*
	...
	*/
	...
	public Scenario5ofdocumentversionnumpbi() {
...
switchToBodyFrame(driver);
		...
		jsClick(addbtnofmaindocinimport, "addbtnofmaindocinimport");
 ...
 * 
 */
public void Documentreturn(String Maindocuniqecodeinimport,String Importremarks) {
 ...
 * 
 */
public void Documentreinitation(String Maindocuniqecodeinimport,String Importremarks) {
	...
	switchToBodyFrame(driver);
	TimeUtil.shortWait();
	jsClick(importreinitiation, "importreinitiation");
	TimeUtil.shortWait();
	switchToDefaultContent(driver);
...
jsClick(searchboxofaudittrail, "searchboxofaudittrail");
    ...
    jsClick(reinitionsselectingrecords, "reinitionsselectingrecords");
	  ...
	  */
	 // jsClick(importremarks, "importremarks");
		sendText(importremarks1,"Importremarks","importremarks1");
...
jsClick(addbtnofasso1, "addbtnofasso1");
  ...
  uploadDocument("C:\\Users\\venkatapm\\OneDrive - caliberuniversal\\Desktop\\txt_janaganamana.pdf");  
	 ...
	 * 
	 */
	public void Documentreturnsub1(String Maindocuniqecodeinimportsub1,String Importremarks) {
	 ...
	 * 
	 */
	public void Documentreinitationsub1(String Maindocuniqecodeinimportsub1,String Importremarks) {
...
//--sub2
	...
	public void Documenttypeimportdocumentregistrationsub2(String Findtxtbtnofassociate,String Maindocuniqecodeinimportsub2,String Documenttitleofmaindocsub2, String Revisionchagedetails,String Changectrlfieldofimportsub2){
	...
	jsClick(selectingassocitatedocument2doc, "selectingassocitatedocument2doc");
	...
	jsClick(addbtnofasso1, "addbtnofasso1");
			  ...
			  TimeUtil.shortWait();
				  ...
				  jsClick(maindocuniqecodeinimport, "maindocuniqecodeinimport");
				  sendText(maindocuniqecodeinimport,Maindocuniqecodeinimportsub2,"maindocuniqecodeinimport");
				
				jsClick(documenttitleofmaindoc, "documenttitleofmaindoc");
				sendText(documenttitleofmaindoc,Documenttitleofmaindocsub2,"documenttitleofmaindoc");  
	  ...
	  uploadDocument("C:\\Users\\venkatapm\\OneDrive - caliberuniversal\\Desktop\\txt_janaganamana.pdf");  
				...
				jsClick(changectrlfieldofimport, "changectrlfieldofimport");
				sendText(changectrlfieldofimport,Changectrlfieldofimportsub2,"changectrlfieldofimport");
		...
		//Audittrailofregistrationorinitiation
				...
				jsClick(searchboxofaudittrail, "searchboxofaudittrail");
				sendText(searchboxofaudittrail,Maindocuniqecodeinimportsub2,"searchboxofaudittrail");
		 ...
		 * 
		 */
		public void Documentreturnsub2(String Maindocuniqecodeinimportsub2,String Importremarks) {
		 ...
		 * 
		 */
		public void Documentreinitationsub2(String Maindocuniqecodeinimportsub2,String Importremarks) {
		 ...
		 * 
		 */
		public void documentReinitApprovalsub2(String Recordsperpageofapprovalofconfigurationmenu,String Maindocuniqecodeinimportsub2) {
		/*	
			jsClick(Documentmanagericon, "Document manager icon tab");
			jsClick(DocumentManagericon, "DocumentManagermenu");
			jsClick(DocumentManagertransactionsubmenu, "DocumentManagertransactionsubmenu");
		 ...
		 jsClick(applybtnofapprovalofconfigurationmenu, "applybtnofapprovalofconfigurationmenu");
		  ...
		  jsClick(searchofapprovalofconfigurationmenu, "searchofapprovalofconfigurationmenu");
		  sendText(searchofapprovalofconfigurationmenu,Maindocuniqecodeinimportsub2, "searchofapprovalofconfigurationmenu");
		  ...
		  JavascriptExecutor js = (JavascriptExecutor) driver;
			...
			*/	
				...
				jsClick(ATfilterofapprovalofconfigurationmenu, "ATfilterofapprovalofconfigurationmenu");
				 ...
				 jsClick(ATsearchofapprovalofconfigurationmenu, "ATsearchofapprovalofconfigurationmenu");
				 sendText(ATsearchofapprovalofconfigurationmenu,Maindocuniqecodeinimportsub2,"ATsearchofapprovalofconfigurationmenu");
...
//-------------------print
		...
		public void Documenttypepublishinitiation(String Findtxtofmaindocsearchinimport,String Maindocuniqecodeinimport,String Numberofcopiesfield,String Remarksofprint){
		    ...
		    jsClick(realmaindoc, "realmaindoc");

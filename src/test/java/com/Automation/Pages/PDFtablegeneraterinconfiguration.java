...
public class PDFtablegeneraterinconfiguration  extends ActionEngine {
	...
	@FindBy(id = "DMS_Configuration_Initiate_MENU0130")
	WebElement PDFtablegeneratormenuininitiateofCONF;
	
	@FindBy(id = "ViewerComponents_PdfTblGenCode")
	WebElement Uniquecodeofpdftablegenerator;
	@FindBy(id= "ViewerComponents_PdfTblGenDesc")
	WebElement descriptionpdftablegenerator;
	@FindBy(id = "ViewerComponents_rowcount")
	WebElement numofrowscomponentinpdftablegenerator;
	@FindBy(id = "ViewerComponents_columncount")
	WebElement numofcolumscomponentinpdftablegenerator;

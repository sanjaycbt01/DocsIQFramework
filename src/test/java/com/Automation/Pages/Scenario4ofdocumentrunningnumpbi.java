...
public class Scenario4ofdocumentrunningnumpbi   extends ActionEngine {
	Properties prop;
...
@FindBy(id = "DMS_Document Manager_Transactions_MENU0102")
WebElement Adcrmenu;


@FindBy(xpath = "//td[contains(text(),'Publish Completed')]")
WebElement adcrpublishcmpdoc;

@FindBy(xpath = "//textarea[@id='DMSDocStatusReset_DocResetDesc']")
WebElement remarksofadcrdoc;

@FindBy(xpath = "//span[contains(text(),'Associated Document Change Request Approval')]")
WebElement adcrmenuinmytasks;

@FindBy(xpath = "//td[contains(text(),'ramg1.g')]")
WebElement recordofapprovalofadcr;

@FindBy(xpath = "//td[contains(text(),'Under Preparation Request Initiation')]")
WebElement recordofunderpreofadcr;

@FindBy(xpath = "//tbody/tr[2]/td[7]/a[1]")
WebElement revisiondocofsub1doc;

@FindBy(xpath = "//input[@id='PreparationRequest_DocumentDesc']")
WebElement textboxofdoctitle;

@FindBy(xpath = "//td[contains(text(),'Under Preparation Initiation')]")
WebElement subdocundrpreadcr;

@FindBy(xpath = "//td[contains(text(),'Under Preparation Initiation')]")
WebElement subdocundrpreadcr1;

@FindBy(xpath = "//td[contains(text(),'Under Preparation Request Initiation')]")
WebElement subdocundrpreadcr1rein;

@FindBy(xpath = "//td[text()='Under Preparation Initiation']")
WebElement subdocundrpreadcr1reinnewrocord;

@FindBy(xpath = "//td[contains(text(),'Publish Completed')]")
WebElement pubcomrecord;
...
@FindBy(id = "btnSubmit")
WebElement SubmitBtnrk;


@FindBy(id = "btnConfirm")
WebElement conformbttn;
...
//test.createNode("EPIQ Login Test").pass("EPIQ Login").createNode("EPIQ PlantSelection Test")
	...
	public Scenario4ofdocumentrunningnumpbi() {
...
public void Documenttypebasicflow(String Searchboxofadcrdoc,String Remarksofadcrdoc){
...
// jsClick(cancelbtnofpopup, "cancelbtnofpopup");
 ...
 jsClick(Documentmanagericon, "Document manager icon tab");
		...
		jsClick(Adcrmenu, "Adcrmenu");
		switchToBodyFrame(driver);
		
		jsClick(searchboxofdocprerequest, "searchboxofdocprerequest");
		sendText(searchboxofdocprerequest,Searchboxofadcrdoc,"searchboxofdocprerequest");
		
		jsClick(searchiconofdocprerequest, "searchiconofdocprerequest");
		
		TimeUtil.shortWait();
		
	jsClick(pubcomrecord, "pubcomrecord");
		
		TimeUtil.shortWait();
		
		//jsClick(remarksofadcrdoc, "remarksofadcrdoc");
		sendText(remarksofadcrdoc,Remarksofadcrdoc,"remarksofadcrdoc");
 ...
 * 
 */
public void Documentprereqapprovar(String Searchboxofadcrdoc) {
	...
	switchToBodyFrame(driver);
	TimeUtil.shortWait();
	jsClick(adcrmenuinmytasks, "adcrmenuinmytasks");
	TimeUtil.shortWait();
	switchToDefaultContent(driver);
	TimeUtil.shortWait();
switchToBodyFrame(driver);
	
jsClick(recordofapprovalofadcr, "recordofapprovalofadcr");
 ...
 * 
 */
public void Documentprereqapprovar1(String Searchboxofadcrdoc,String Textboxofdoctitle,String eSign ) throws AWTException {
    ...
    jsClick(subdocundrpreadcr1rein, "subdocundrpreadcr1rein");
    
	  TimeUtil.shortWait();

	  jsClick(revisiondocofsub1doc, "revisiondocofsub1doc");
	  
	  TimeUtil.shortWait();
	  
	  jsClick(conformbttn, "conformbttn");
	  
	  jsClick(SubmitBtn, "Submit Btn"); 
	
	 
	  jsClick(subdocundrpreadcr1, "subdocundrpreadcr1");
	...
	//  jsClick(SubmitBtn, "Submit Btn");
	  ...
	  jsClick(subdocundrpreadcr, "recordofunderpreofadcr"); 
	  ...
	  jsClick(textboxofdoctitle, "textboxofdoctitle");
	  sendText(textboxofdoctitle,Textboxofdoctitle,"textboxofdoctitle");
	  
	  jsClick(conformbttn, "conformbttn");
	  
	TimeUtil.shortWait();
			
		 jsClick(SubmitBtn, "submitbutton");
		 
		 TimeUtil.shortWait();
		 
		 jsClick(subdocundrpreadcr, "subdocundrpreadcr"); 
 ...
 * 
 */
public void documentapprovarpreparationstage(String Searchboxofadcrdoc,String eSign) {
...
public void Documenttypepublishinitiation(String Searchboxofadcrdoc,String eSign){
 ...
 /**
	 ...
	 * 
	 */
	public void Documentpublishinitiationapproval(String Searchboxofadcrdoc,String eSign) {
	 ...
	 * 
	 */
	public void Documentprintinitiation(String Searchboxofadcrdoc ) {

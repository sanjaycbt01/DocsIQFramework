...
public class Scenario2ofdocumentrunningnum extends ActionEngine {
	Properties prop;
...
//	@FindBy(id = "ddlSelectedPlant_2")
	...
	// @FindBy(xpath = "//div[contains(text(),'Cannot Create Session for Quality
	// Management Syste')]")
//	WebElement xbutton;
...
//	WebElement Documentmanagericon;
	...
	// same search 3
	/*
	 * @FindBy(xpath = "//*[@placeholder='Search This Page']") WebElement
	 * searchboxofdocprerequest;
	 * 
	 * @FindBy(xpath = "//*[@class='ft-search']") WebElement
	 * searchiconofdocprerequest;
	 */
...
//---------------------------------------------------------------------
	...
	/*
	 * 
	 * @FindBy(id = "DMS_Document Manager_Transactions") WebElement
	 * documentmanagertransactionsmenu;
	 * 
	 * @FindBy(id = "DMS_Document Manager_Transactions_MENU0041") WebElement
	 * mytaskmenu;
	 * 
	 * @FindBy(xpath = "//span[contains(text(),'Document Tasks')]") WebElement
	 * documenttasks;
	 * 
	 */
...
//test.createNode("EPIQ Login Test").pass("EPIQ Login").createNode("EPIQ PlantSelection Test")
	...
	public Scenario2ofdocumentrunningnum() {
	...
	public void Documenttypebasicflow(String Searchboxofdocprerequest, String Findtextofrevexidoc,
			String documenttitleofdocprereq, String Changecontrolnumtextbox) {
...
//uploadDocument("C:\\Users\\venkatapm\\OneDrive - caliberuniversal\\Desktop\\ramkri.docx");
		...
		/*
		 * pasteDataUsingRobot("venkatapm"); Robot robot; robot = new Robot();
		 * TimeUtil.shortWait(); robot.keyPress(KeyEvent.VK_DOWN); TimeUtil.shortWait();
		 * robot.keyPress(KeyEvent.VK_TAB); pasteDataUsingRobot("TRY@1234");
		 * TimeUtil.shortWait(); robot.keyPress(KeyEvent.VK_DOWN); TimeUtil.shortWait();
		 * robot.keyPress(KeyEvent.VK_TAB); TimeUtil.shortWait();
...
//pasteDataUsingRobot("venkatapm");
		/*
		 * Robot robot; robot = new Robot(); TimeUtil.shortWait();
		 * 
		 * 
		 * robot.keyPress(KeyEvent.VK_ENTER); // robot.keyPress(KeyEvent.VK_ENTER);
		 * TimeUtil.shortWait(); // jsClick(cancelbtnofpopup, "cancelbtnofpopup");
		 * 
		 * // TimeUtil.shortWait();
		 */
	 ...
	 * 
	 */
	public void Documentprereqapprovar1(String Searchboxofdoctype, String Txtboxofsub1docnew, String Txtboxofsub2docnew,
			String Txtboxofsub3doc, String Txtboxofsub4doc, String Txtboxofsub5doc, String eSign) throws AWTException {
		 ...
		 * 
		 * // pasteDataUsingRobot("venkatapm"); Robot robot; robot = new Robot();
		 * TimeUtil.longwait(); TimeUtil.longwait(); //
		 * robot.keyPress(KeyEvent.KEY_LOCATION_NUMPAD);
		 * robot.keyPress(KeyEvent.VK_ENTER); robot.keyPress(KeyEvent.VK_ENTER);
		 * TimeUtil.shortWait(); robot.keyPress(KeyEvent.VK_TAB); TimeUtil.shortWait();
		 */
		...
		jsClick(sub3docnew, "sub3docnew");

		// jsClick(txtboxofsub2doc, "txtboxofsub1doc ");
		sendText(txtboxofsub2doc, Txtboxofsub3doc, "txtboxofsub1doc");
		...
		jsClick(sub4docnew, "sub4docnew");

		// jsClick(txtboxofsub2doc, "txtboxofsub1doc ");
		sendText(txtboxofsub2doc, Txtboxofsub4doc, "txtboxofsub1doc");
		...
		jsClick(sub5docnew, "sub5docnew");

		// jsClick(txtboxofsub2doc, "txtboxofsub1doc ");
		sendText(txtboxofsub2doc, Txtboxofsub5doc, "txtboxofsub1doc");
		...
		jsClick(sub3docnewnext, "sub1docnewnext");
		...
		jsClick(sub4docnewnext, "sub4docnewnext");
		...
		jsClick(sub5docnewnext, "sub5docnewnext");
	...
	public void Documenttypepublishinitiation(String Searchboxofdoctype, String Searchbtnofotherscreen,
			String Printreason, String eSign) {
		 ...
		 * sendText(searchbtnofotherscreen,Searchbtnofotherscreen,
		 * "searchbtnofotherscreen");
		 * 

...
public class Documentversionnumberscenario4   extends ActionEngine {
	Properties prop;
...
//td[contains(text(),'System.Manager')]


//span[@id='select2-RePrintRequest_CopyNo-container']

//ul[@id='select2-RePrintRequest_CopyNo-results']/li[2]


//                 RePrintRequest_PrintReqDesc

//button[@id='btnModal_RePrintRequest_Document']


//tbody/tr[1]/td[1]/input[1]

//button[@id='RePrintRequest_Document_selectBtn']

//span[text()='Reprint Request Approval']
...
//test.createNode("EPIQ Login Test").pass("EPIQ Login").createNode("EPIQ PlantSelection Test")
	...
	public Documentversionnumberscenario4() {
...
public void Documenttypebasicflow(String Searchboxofdocprerequest,String documenttitleofdocprereqrev,String Changecontrolnumtextboxrev,String Findtextofrevexidoc){
...
// jsClick(cancelbtnofpopup, "cancelbtnofpopup");
 ...
 jsClick(Documentmanagericon, "Document manager icon tab");
	...
	TimeUtil.shortWait();
		...
		jsClick(revisionradiobtn, "revisionradiobtn");
		
		jsClick(addbtnofexistverdoc, "addbtnofexistverdoc");
	...
	jsClick(Documenttitleofdocprereq, "Documenttitleofdocprereq");
		sendText(Documenttitleofdocprereq,documenttitleofdocprereqrev,"Documenttitleofdocprereq");
		
		jsClick(changecontrolnumtextbox, "changecontrolnumtextbox");
		sendText(changecontrolnumtextbox,Changecontrolnumtextboxrev,"changecontrolnumtextbox");
...
public void Documentprereqapprovar1(String Searchboxofdoctype,String Txtboxofsub1doc,String Txtboxofsub2doc,String eSign ) throws AWTException {
	...
	/*  
	 ...
	 E_sign.e_Sign(eSign);
			...
			jsClick(sub1ofnewrev, "sub1ofnewrev"); 
		...
		//	 E_sign.e_Sign(eSign);
			...
			//	TimeUtil.shortWait();
				...
				jsClick(sub2ofnewrev, "sub2ofnewrev"); 

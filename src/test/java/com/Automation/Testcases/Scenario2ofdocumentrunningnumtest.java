...
public class Scenario2ofdocumentrunningnumtest   extends  ActionEngine {
	...
	public Scenario2ofdocumentrunningnumtest() {
...
// REGISTRATION_RETURN_REINITIATION_APROVAL_
		...
		public void Newvesiondoctypeflow(String Searchboxofdocprerequest,String Findtextofrevexidoc,String documenttitleofdocprereq, String Changecontrolnumtextbox,String Searchboxofdoctype,
			...
			this.test = extent.createTest("Scenario 2-Verification of updating main document unique code in annexure unique code during the publish stage(Revision)");
		...
		//	for (int i = 1; i <= 3; i++) {	
			...
			.pass("EPIQ PlantSelection");
				...
				epicloginpageoq.epicdmsLogin(ConfigsReader.getPropValue("companycodeepiq"),ConfigsReader.getPropValue("usernameepic"), ConfigsReader.getPropValue("pwdepic"));
			epiqplant.epicplant();
			documentrunningnumscena2.Documenttypebasicflow(Searchboxofdocprerequest, Findtextofrevexidoc, documenttitleofdocprereq, Changecontrolnumtextbox);
		...
		epiqplant.epicplant();
		documentrunningnumscena2.Documentprereqapprovar(Searchboxofdoctype);
	
	epicloginpageoq.epicdmsLogin(ConfigsReader.getPropValue("companycodeepiq"),ConfigsReader.getPropValue("usernameepic"), ConfigsReader.getPropValue("pwdepic"));
	epiqplant.epicplant();
	documentrunningnumscena2.Documentprereqapprovar1(Searchboxofdoctype, Txtboxofsub1docnew,Txtboxofsub3docnew,Txtboxofsub1docnew,Txtboxofsub4docnew,Txtboxofsub5docnew,ConfigsReader.getPropValue("pwdepic"));
		
   epiqnewtest1newperson.epicdmsLogin(ConfigsReader.getPropValue("companycodeepiq1"),ConfigsReader.getPropValue("usernameepic1"), ConfigsReader.getPropValue("pwdepic1"));
	epiqplant.epicplant();
	documentrunningnumscena2.documentapprovarpreparationstage(Searchboxofdoctype, ConfigsReader.getPropValue("pwdepic1"));
    ...
    epicloginpageoq.epicdmsLogin(ConfigsReader.getPropValue("companycodeepiq"),ConfigsReader.getPropValue("usernameepic"), ConfigsReader.getPropValue("pwdepic"));
	epiqplant.epicplant();
	documentrunningnumscena2.Documenttypepublishinitiation(Searchboxofdoctype, Searchbtnofotherscreen, Printreason,ConfigsReader.getPropValue("pwdepic"));

	epiqnewtest1newperson.epicdmsLogin(ConfigsReader.getPropValue("companycodeepiq1"),ConfigsReader.getPropValue("usernameepic1"), ConfigsReader.getPropValue("pwdepic1"));
epiqplant.epicplant();
documentrunningnumscena2.Documentpublishinitiationapproval(Searchboxofdoctype, ConfigsReader.getPropValue("pwdepic1"));
		
epicloginpageoq.epicdmsLogin(ConfigsReader.getPropValue("companycodeepiq"),ConfigsReader.getPropValue("usernameepic"), ConfigsReader.getPropValue("pwdepic"));
epiqplant.epicplant();
documentrunningnumscena2.Documentprintinitiation(Searchboxofdoctype);
